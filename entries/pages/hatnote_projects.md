...
- **2019-**: Still going strong, with _over 2 million_ satisfied users
...
project_link: https://montage.toolforge.org/
description: |
...
[IFTTT][ifttt_wp] (_IF This Then That_) is a web service for
...
articles, [_See, Also_][see_also] is a virtual gallery of Wikipedia-derived
...
architecture of _See, Also_ partially inspired [chert][Chert], the
...
solvers, retained _explainability_ of the model. That meant we could
