...
Enter `ecoutils`. `ecoutils` is a pure-Python module that, using nothing
but builtins, generates a semantic, Python-centric profile of the
environment that's running it. This includes:
