...
Still alive, but still niche.

::: {.fragment}
**2009–** ![](images/hist_skulpt.png){height="1.2em" style="vertical-align: middle;"} - JS reimplementation, still chasing Python 3
:::

::: {.fragment}
**2014–** ![](images/hist_brython.png){height="1.2em" style="vertical-align: middle;"} - Runtime transpiler, maintained (Python 3.14), no C extensions
:::

::: {.fragment}
**2016–** ![](images/hist_transcrypt_pyreact.png){height="1.2em" style="vertical-align: middle;"} **Transcrypt** - Python-to-JS transpiler, active (v3.9.4)
:::
...
| ![](images/logo_pyscript.svg){height="1.2em" style="vertical-align: middle;"} **PyScript** | Python in the browser platform (Anaconda) | [pyscript.com](https://pyscript.com/) |
::::
...
Data exploration with [glom](https://github.com/mahmoud/glom)
...
Like GitHub for consumer finance.
...
An agent-assisted human beats a pure agent.

. . .

Ecosystem and community are real advantages.
