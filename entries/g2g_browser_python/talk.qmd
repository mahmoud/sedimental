...
::: {.fragment}
**2009–present** - ![](images/hist_skulpt.png){height="1.2em" style="vertical-align: middle;"} **Skulpt**: JS reimplementation, still chasing Python 3
:::

::: {.fragment}
**2014–present** - ![](images/hist_brython.png){height="1.2em" style="vertical-align: middle;"} **Brython**: Runtime transpiler, maintained (Python 3.14), no C extensions
:::
